...
class TestTrueFalseQuestionModel(TestCase):
    def setUp(self):
        self.red = TF_Question.objects.create(
            content="Is red the best?",
            explanation="it is",
            correct=True,
        )
        self.blue = TF_Question.objects.create(
            content="Is blue the best?",
    ...
    def test_get_answers(self):
        self.assertEqual(
            self.red.get_answers(),
            [
                {"correct": True, "content": "True"},
